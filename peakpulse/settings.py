"""
Django settings for peakpulse project.
...
SECRET_KEY = 'django-insecure-%0!_dv942*@@(^$yv*ae9=4@u78niax7wb^^2!0@rb$%1_wn7l'
...
WSGI_APPLICATION = 'peakpulse.wsgi.application'
